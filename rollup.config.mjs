    ...
    plugins: [
        copyAndWatch({
            targets: [
                ...
                { src: 'node_modules/onnxruntime-web/dist/ort-wasm-simd-threaded.jsep.mjs', dest: 'static/lib/onnxruntime' },
                { src: 'node_modules/onnxruntime-web/dist/ort-wasm-simd-threaded.jsep.wasm', dest: 'static/lib/onnxruntime' },
                { src: 'node_modules/onnxruntime-web/dist/ort-wasm-simd-threaded.mjs', dest: 'static/lib/onnxruntime' },
                { src: 'node_modules/onnxruntime-web/dist/ort-wasm-simd-threaded.wasm', dest: 'static/lib/onnxruntime' },
